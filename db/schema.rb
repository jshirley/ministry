...
ActiveRecord::Schema.define(version: 20140803215255) do
  ...
  add_index "obstacles", ["project_id"], name: "index_obstacles_on_project_id", using: :btree
  add_index "obstacles", ["user_id"], name: "index_obstacles_on_user_id", using: :btree
